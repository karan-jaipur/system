...
const Navgood = () => {
  return (
    <div>
      <nav className="navbar navbar-expand-lg shadow navgoo">
        <div className="container-fluid">
          <img src=''></img>
          <a class="navbar-brand" href="#">
      <img src="https://systumm.com/wp-content/uploads/2023/11/Untitled-design-1.png" alt="Bootstrap" width="200" height="60"/>
    </a>
