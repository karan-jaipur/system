...
<div style={{ backgroundColor: 'rgb(234, 240, 255)' }}>
  <div className='container py-5' >
    <h1 className='py-5' style={{ fontSize: '50px', fontWeight: '700' }}>Hoodies & Sweatshirts</h1>
  </div>
</div>
  ...
  <div className='row'>
    <div className='col-lg-3 '>
      <div className='d-flex gap-2'>
        ...
        <div><h6>Shop</h6></div>
        <div><i class="fa-solid fa-angle-right"></i></div>
        <div><p> Hoodies & sweatshirts</p></div>
      </div>
  ...
  <div className='row' style={{rowGap:"15px"}} >
    {
      eksath.map((a,value) => {
        return (
          <div key={value} className=' col-lg-4 col-md-4 col-sm-12 py-5' style={{borderRadius:'20px',}}>
